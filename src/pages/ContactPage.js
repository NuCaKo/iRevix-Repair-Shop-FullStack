...
function ContactPage() {
    ...
    // Initialize EmailJS
    useEffect(() => {
        emailjs.init("3XVXPtxPTpY3W8t12"); // Your public key
    }, []);
    ...
    const handleSubmit = (e) => {
        ...
        // EmailJS service configuration with your actual values
        const serviceID = 'service_qu0jjc9'; // Your Service ID
        const templateID = 'template_qlkea87'; // Your Template ID

        // Prepare template parameters - match these exactly with your template variables!
        const templateParams = {
            from_name: formData.name,
            name: formData.name, // Adding this as many templates use "name"
            email: formData.email,
            from_email: formData.email,
            subject: formData.subject || 'New Contact Form Submission from iRevix Website',
            message: formData.message,
            message_html: formData.message.replace(/\n/g, '<br>') // For HTML email formatting
        };
