...
-- *** IMPORTANT: Insert devices with correct icon names ***
...
-- Insert inventory items from hugeinventorydatabase.sql
-- (careful with the case of device_type and model_type!)
